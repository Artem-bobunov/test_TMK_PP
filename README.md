...
- Главная страница приложения. На этой странице пользователь может просматриват всю информацию связанных между собой таблиц.
...
### Итоги
В первой части тестового задания была создана бд и приложение, приписаны модели с использовнием Django-ORM чтобы отразить структуру таблиц БД. Создано приложение с использванием Djnago, написана серверная часть проекта. Первая часть проекта позоволяет просматривать и редактировать информацию ссправочников и документов.
...
- Страница обновления данных
  ...
  В результате продланной работы в тестовой части №2 были разработны алгоритмы указанные в задании, доработана серверная часть,а, также отображение и способы редактирования информации.
